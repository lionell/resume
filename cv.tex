...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {M.S. in Computer Science; GPA: 3.94/4.0}{Sep 2018 -- Jun 2020}
    \resumeSubheading
      {Taras Shevchenko National University}{Kyiv, Ukraine}
      {B.S. in Computer Science;  GPA: 3.98/4.0}{Sep 2014 -- Jun 2018}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Was part of Test Infrastructure team and then Continuous Integration Analytics team (CIA).}
        \resumeItem{Designed and implemented service that computes Probabilistic Flakiness Score in real-time via Bayesian inference.}
        \resumeItem{Scaled PFS service CPU utilization 10x, latency 20x, number of replicas 7.5x via profiling/caching/parallelism.}
        \resumeItem{Post with details: https://engineering.fb.com/2020/12/10/developer-tools/probabilistic-flakiness/}
        ...
        \resumeItem{It reduced MSLE by 50\% and allows to control confidence levels of the prediction (thx to Monte-Carlo dropout).}
        \resumeItem{This gives a way to show uncertanty to user and not only point-estimate (UX research finds this misleading).}
      \resumeItemListEnd
